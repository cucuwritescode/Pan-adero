/* ------------------------------------------------------------
name: "panadero"
 Este codigo de C está generado en su mayoría automáticamente desde "panadero.dsp", el algoritmo de dsp que desarrolle en el
 lenguaje FAUST para emular un AUTOPAN>>>>>>>>>>>> Code generated with Faust 2.74.6 (https://faust.grame.fr)
...
#ifndef __export__
#define __export__
//version como un string global
#define FAUSTVERSION "2.74.6"
//version como valores separados [major,minor,patch]
...
class FAUST_API PathBuilder {
    ...
    protected:
        ...
        void computeShortNames()
        {
            ...
            std::map<std::string, std::string> unique2full;
            char num_buffer[16];
            int pnum = 0;
...
struct CustomLookAndFeel : public juce::LookAndFeel_V3
{
                           ...
                           float rotaryStartAngle, float rotaryEndAngle, juce::Slider& slider) override
    {
        ...
        if (slider.isEnabled()) {
            g.setColour(juce::Colours::maroon.withAlpha (isMouseOver ? 1.0f : 0.7f));
        } else {
...
{
    setSize(600, 500); //tamano de la ventana/editor
    auto customFont = juce::Font(juce::Typeface::createSystemTypefaceFor(BinaryData::Baby_Teeth_ttf, BinaryData::Baby_Teeth_ttfSize));
    //aca inicializo el "cucu dsp" label
    dspLabel.setText("cucu dsp", juce::dontSendNotification);
    dspLabel.setJustificationType(juce::Justification::centred);
    dspLabel.setFont(customFont);
    //dspLabel.setFont(juce::Font(16.0f, juce::Font::bold));
    dspLabel.setColour(juce::Label::textColourId, juce::Colours::black);
    addAndMakeVisible(dspLabel);
    
    //llamo a resized para posicionar los componentes
    //DBG("Constructor: dspLabel initialized and added to visible components"); //debug prueba
    resized();
...
{
    dspLabel.setBounds(280,50,65,19); //para ajustar posicion y tamano
    //DBG("Resized: dspLabel bounds set"); //debug prueba
